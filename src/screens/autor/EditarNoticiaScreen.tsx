...
type EditarNoticiaNavigationProp = StackNavigationProp<
  RootStackParamList,
  'EditarNoticia'
>;
type EditarNoticiaRouteProp = RouteProp<RootStackParamList, 'EditarNoticia'>;

interface Props {
  navigation: EditarNoticiaNavigationProp;
  route: EditarNoticiaRouteProp;
}

// ─── Componente ────────────────────────────────────────────────────────────

const EditarNoticiaScreen: React.FC<Props> = ({ navigation, route }) => {
